...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" =>
1, "price" => $row_p['productPrice']); header('location:my-wishlist.php'); }
...
<html lang="en">
  <head>
    ...
    />
    <link
      href="assets/css/red.css"
      rel="alternate stylesheet"
      title="Red color"
    />
    <link
      href="assets/css/orange.css"
      rel="alternate stylesheet"
      title="Orange color"
    />
    <link
      href="assets/css/dark-green.css"
      rel="alternate stylesheet"
                  ...
                  <tbody>
                    <?php
                      ...
                      $num=mysqli_num_rows($ret);
                        if($num>0) { while ($row=mysqli_fetch_array($ret)) { ?>
                    <tr>
                      <td class="col-md-2">
                        <img
                      ...
                      <td class="col-md-2 close-btn">
                        <a
                          href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>"
