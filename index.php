...
<html lang="en">
	<head>
	    ...
	    <title>Automobile Shopee Home Page</title>
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#exterior" data-toggle="tab">Exterior</a></li>
				</ul>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Interior</h3>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Exterior</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
					<?php
				$ret=mysqli_query($con,"select * from products where category=8 and subCategory=17");
				while ($row=mysqli_fetch_array($ret)) 
				{
				?>
		<div class="item item-carousel">
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		...
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
				$ret=mysqli_query($con,"select * from products where category=10 and subCategory=30");
				while ($row=mysqli_fetch_array($ret)) 
				{
				?>
				<div class="item">
